...
- 다이어그램 viewBox 1600x900, 스타일 계약: 제목 블록(테라코타 바 + `DIAGRAM NN`) / 점 패턴 배경 / 틴트 밴드 / 그림자 카드 / 상태 알약 / 라벨 곡선 화살표 - 승인 샘플: `.superpowers/brainstorm/17823-1786318469/content/diagram-01-redraw-sample.svg`
...
- [ ] `_includes/footer.html`: `(c) 2026 Sangmin Kim` 한 줄 (online-cv 크레딧 제거, `footer` 데이터 대신 하드코딩하고 data의 footer 키 삭제)
